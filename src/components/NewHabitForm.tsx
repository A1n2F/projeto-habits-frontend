    ...
    return (
        <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
            ...
            <input 
                ...
                focus:ring-violet-800 focus:ring-offset-2 focus:ring-offset-zinc-900"
                autoFocus
                value={title}
            ...
            <button type="submit" className="mt-6 rounded-lg p-4 flex items-center justify-center gap-3 font-semibold bg-green-600
                hover:bg-green-500 transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-green-800 
